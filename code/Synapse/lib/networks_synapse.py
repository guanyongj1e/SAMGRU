...
from lib.modelGRU import SAGRU
...
class MERIT_Parallel_SAGRU(nn.Module):
    def __init__(self, n_class=1, img_size_s1=(256,256), img_size_s2=(224,224), model_scale='small', decoder_aggregation='additive', interpolation='bilinear'):
        super(MERIT_Parallel_SAGRU, self).__init__()
        ...
        self.sagru = SAGRU(input_channels=96, hidden_channels=[96], kernel_size=5,
                           bias=True, num_classes=n_class, attenion_size=32*32,
                           encoder=None)
